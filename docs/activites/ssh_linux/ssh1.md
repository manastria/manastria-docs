...
1.  **Test des sous-interfaces du routeur**
...
1.  **Test depuis le client** Pour ce test initial, configurez une IP statique sur le client :
    1.  IP : 192.168.20.100
    2.  Masque : 255.255.255.0
...
1.  **Observation du processus DHCP en temps réel**
...
1.  **Vérification des baux DHCP** Sur le serveur Debian :
...
1.  Sur le routeur, confirmez que les requêtes sont relayées :
